...
#include "lcd/extui/lib/btt_ui/TSC_Menu.h"
bool VIOLENCE_flag = false;
bool G28_flag=false;
bool G29_flag=false;
...
void abortSDPrinting() {
    ...
    TERN_(POWER_LOSS_RECOVERY, recovery.purge());
      ...
      TERN_(EXTENSIBLE_UI, ExtUI::onEndscript());
...
void setup() {
  ...
  marlin_state = MF_RUNNING;
      ...
      pinMode(PROVE_CONTROL_PIN,OUTPUT);
      digitalWrite(PROVE_CONTROL_PIN,LOW);
  #endif
