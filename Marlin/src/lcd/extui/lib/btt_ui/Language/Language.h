...
enum
{
  ...
  LABEL_SOFTENING,//Restore default
  LABEL_DEFAULT,
  LABEL_IS_DEFAULT,
  LABEL_DEFAULT_OK,
  LABEL_LEVEL_TEMP,
  LABEL_PSTOP,
  LABEL_LEVEL_BED_TEMP,
  LABEL_LEVELING_OVEL,
  LABEL_LEVELING_ING,
  LABEL_MOVEMENT,
  LABEL_OFF,
  ...
  LABEL_MESH_VALID,
  LABEL_WAIT_FOR_TEMP,
  LABEL_STOP_PLANE_TEST,
  LABEL_IS_BABYSTEP,
  LABEL_IS_LANGUAGE,
  LABEL_HOT_HOMING_ON,    
  LABEL_HOT_HOMING_OFF,  
  LABEL_HOT_HOMING_START, 
  LABEL_HOT_HOMING_Z_HOMING,       
  LABEL_HOT_HOMING_STOP,  
  LABEL_LIST_MODE,       
  LABEL_ICON_MODE, 
