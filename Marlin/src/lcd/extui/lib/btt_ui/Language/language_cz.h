...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define CZ_PRINTING_COMPLETED   "Printing completed!"
    ...
    #define CZ_SOFTENING            "Změkčování spotřebního materiálu"
    #define CZ_DEFAULT              "resetovat"
    #define CZ_IS_DEFAULT           "Potvrdit obnovení továrního nastavení?"
    #define CZ_DEFAULT_OK           "Tovární nastavení bylo obnoveno!"
    #define CZ_LEVEL_TEMP           "Počkejte, až se topná tyč stabilizuje na 140 stupňů"
    #define CZ_PSTOP                "Počkejte, až vynulování skončí. ."
    #define CZ_LEVEL_BED_TEMP       "Horká postel se stabilizuje na 60 stupňů"
    #define CZ_LEVELING_OVEL        "Nivelace je dokončena!"
    #define CZ_LEVELING_ING         "Nivelace. ."
    #define CZ_MOVEMENT             "hnutí"
    #define CZ_OFF                  "OFF"
    #define CZ_ON                   "ON"
    #define CZ_COLDEXTRUD           "Vytlačování za studena je zakázáno (T0 <170 stupňů)"
    #define CZ_COLDEXTRUD170        "Zahřát"
    #define CZ_CLEARNOZZ            "Vyčistěte trysky včas. ."
    #define CZ_MODE_SELECT          "Výběr režimu"
    #define CZ_POWERLOSS_ON         "PLR ON"
    #define CZ_POWERLOSS_OFF        "PLR OFF"
    #define CZ_MOTOR_UNLOCK         "Odemknutí motoru"
    #define CZ_MESH_VALID           "Test nivelace"
    #define CZ_WAIT_FOR_TEMP        "Počkejte, až teplota stoupne na cílovou teplotu"
    #define CZ_STOP_PLANE_TEST      "Chcete zastavit zkoušku nivelace?"
    #define CZ_IS_BABYSTEP          "Opravdu uložíte vyladěnou hodnotu?"
    #define CZ_IS_LANGUAGE          "Opravdu nastavení uložíte?"
    #define CZ_HOT_HOMING_ON        "HOT HOME:ON"
    #define CZ_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define CZ_HOT_HOMING_START     "HOT HOME:START!"
    #define CZ_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define CZ_HOT_HOMING_STOP      "HOT HOME:OK!"    
    #define CZ_LIST_MODE            "LIST"
    #define CZ_ICON_MODE            "ICON"
#endif
#endif
