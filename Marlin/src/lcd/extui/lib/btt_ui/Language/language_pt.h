...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define PT_SOFTENING            "Amolecer"
    #define PT_DEFAULT              "Predefinido"
    #define PT_IS_DEFAULT           "Restaurar configurações padrão?"
    #define PT_DEFAULT_OK           "Configuração padrão restaurada"
    #define PT_LEVEL_TEMP           "Vara de aquecimento 140 Graus"
    #define PT_PSTOP                "Espere pelo FIM de zeros."
    #define PT_LEVEL_BED_TEMP       "Cama Quente estável até 60ºgraus"
    #define PT_LEVELING_OVEL        "Nível completo!"
    #define PT_LEVELING_ING         "Em nivelamento..."
    #define PT_MOVEMENT             "Movimento"
    #define PT_OFF                  "OFF"
    #define PT_ON                   "ON"
    #define PT_COLDEXTRUD           "Sem extrusão a Frio (t0 < 170 graus)"
    #define PT_COLDEXTRUD170        "Pré-aquecimento"
    #define PT_CLEARNOZZ            "Wyczyść dyszę!"
    #define PT_MODE_SELECT          "Selecção do modo"
    #define PT_POWERLOSS_ON         "PLR ON"
    #define PT_POWERLOSS_OFF        "PLR OFF"
    #define PT_MOTOR_UNLOCK         "Desbloqueio"
    #define PT_MESH_VALID           "Ensaio"
    #define PT_WAIT_FOR_TEMP        "Por favor, aguarde a temperatura Subir para a temperatura alvo"
    #define PT_STOP_PLANE_TEST      "Parar teste de nivelamento?"
    #define PT_IS_BABYSTEP          "Você TEM certeza de salvar o valor de aparar?"
    #define PT_IS_LANGUAGE          "Tem certeza de que deseja salvar as configurações?"
    #define PT_HOT_HOMING_ON        "HOT HOME:ON"
    #define PT_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define PT_HOT_HOMING_START     "HOT HOME:START!"
    #define PT_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define PT_HOT_HOMING_STOP      "HOT HOME:OK!"    
    #define PT_LIST_MODE            "LIST"
    #define PT_ICON_MODE            "ICON"
#endif
#endif
