...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define RU_SOFTENING            "Расходные материалы для смягчения"
    #define RU_DEFAULT              "сброс настроек"
    #define RU_IS_DEFAULT           "Подтвердить восстановление заводских настроек?"
    #define RU_DEFAULT_OK           "Заводские настройки восстановлены!"
    #define RU_LEVEL_TEMP           "Подождите, пока нагревательный стержень стабилизируется до 140 градусов." 
    #define RU_PSTOP                "Жду окончания обнуления.."
    #define RU_LEVEL_BED_TEMP       "Горячая кровать стабилизируется до 60 градусов"
    #define RU_LEVELING_OVEL        "Прокачка завершена!"
    #define RU_LEVELING_ING         "Выравнивание. ."
    #define RU_MOVEMENT             "движение"
    #define RU_OFF                  "OFF"
    #define RU_ON                   "ON"
    #define RU_COLDEXTRUD           "Холодная экструзия запрещена (T0 <170 градусов)"
    #define RU_COLDEXTRUD170        "Разогрев"
    #define RU_CLEARNOZZ            "Очистите насадку!"
    #define RU_MODE_SELECT          "Выбор режима"
    #define RU_POWERLOSS_ON         "PLR ON"
    #define RU_POWERLOSS_OFF        "PLR OFF"
    #define RU_MOTOR_UNLOCK         "Разблокировка двигателя"
    #define RU_MESH_VALID           "Тест на выравнивание"
    #define RU_WAIT_FOR_TEMP        "Подождите, пока температура не поднимется до заданной."
    #define RU_STOP_PLANE_TEST      "Вы хотите остановить тест на выравнивание?"
    #define RU_IS_BABYSTEP          "Вы уверены, что сохраните настроенное значение?"    
    #define RU_IS_LANGUAGE          "Вы уверены, что сохраните настройки?"
    #define RU_HOT_HOMING_ON        "HOT HOME:ON"
    #define RU_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define RU_HOT_HOMING_START     "HOT HOME:START!"
    #define RU_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define RU_HOT_HOMING_STOP      "HOT HOME:OK!" 
    #define RU_LIST_MODE            "LIST"
    #define RU_ICON_MODE            "ICON"   
#endif
#endif
