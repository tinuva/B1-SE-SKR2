...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define PL_SOFTENING            "zmiękczaj"
    #define PL_DEFAULT              "domyślne"
    #define PL_IS_DEFAULT           "Przywróć ustawienia domyślne?"
    #define PL_DEFAULT_OK           "Ustawienia domyślne przywrócone!"
    #define PL_LEVEL_TEMP           "Czekać na stabilizację prętu do 140 stopni"
    #define PL_PSTOP                "Czekaj na koniec zera.."
    #define PL_LEVEL_BED_TEMP       "Gorące łóżko jest ustabilizowane do 60 stopni"
    #define PL_LEVELING_OVEL        "Pozew zakończony!"
    #define PL_LEVELING_ING         "Dźwiganie..."
    #define PL_MOVEMENT             "ruch"
    #define PL_OFF                  "OFF"
    #define PL_ON                   "ON"
    #define PL_COLDEXTRUD           "Brak wytłaczania zimnego (t0 ” 170 stopni)"
    #define PL_COLDEXTRUD170        "podgrzewacz"
    #define PL_CLEARNOZZ            "Limpe o bico!"
    #define PL_MODE_SELECT          "Wybór trybu"
    #define PL_POWERLOSS_ON         "PLR ON"
    #define PL_POWERLOSS_OFF        "PLR OFF"
    #define PL_MOTOR_UNLOCK         "Odblokowanie"
    #define PL_MESH_VALID           "badanie"
    #define PL_WAIT_FOR_TEMP        "Proszę czekać, aż temperatura do temperatury docelowej wzrośnie."
    #define PL_STOP_PLANE_TEST      "Przestać poziomować?"
    #define PL_IS_BABYSTEP          "Jesteś pewien, że zachowasz wartość przycinania?"
    #define PL_IS_LANGUAGE          "Czy na pewno chcesz zapisać ustawienia?"
    #define PL_HOT_HOMING_ON        "HOT HOME:ON"
    #define PL_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define PL_HOT_HOMING_START     "HOT HOME:START!"
    #define PL_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define PL_HOT_HOMING_STOP      "HOT HOME:OK!"    
    #define PL_LIST_MODE            "LIST"
    #define PL_ICON_MODE            "ICON"
#endif
#endif
