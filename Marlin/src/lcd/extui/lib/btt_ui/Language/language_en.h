...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define EN_AUTO_SHUT_DOWN       "Auto Power ON"
    #define EN_MANUAL_SHUT_DOWN     "Auto Power OFF"
    ...
    #define EN_SOFTENING            "Softening"
    #define EN_DEFAULT              "Restore default"
    #define EN_IS_DEFAULT           "Are you sure to restore factory settings?"
    #define EN_DEFAULT_OK           "Factory settings have been restored!"
    #define EN_LEVEL_TEMP           "Wait for E0 to stabilize to 140 degrees" 
    #define EN_PSTOP                "Waiting for zero.."
    #define EN_LEVEL_BED_TEMP       "The hot bed stabilizes to 60"
    #define EN_LEVELING_OVEL        "Leveling is over!"
    #define EN_LEVELING_ING         "Leveling..."
    #define EN_MOVEMENT             "Movement"
    #define EN_OFF                  "OFF"
    #define EN_ON                   "ON"
    #define EN_COLDEXTRUD           "No cold extrusion (t0 < 170 degrees)"
    #define EN_COLDEXTRUD170        "preheat"
    #define EN_CLEARNOZZ            "Please clean the nozzle！"
    #define EN_MODE_SELECT          "Mode selection"
    #define EN_POWERLOSS_ON         "PLR ON"
    #define EN_POWERLOSS_OFF        "PLR OFF"
    #define EN_MOTOR_UNLOCK         "motor unlock"
    #define EN_MESH_VALID           "Mesh Validation"
    #define EN_WAIT_FOR_TEMP        "Please wait for the temperature to rise"
    #define EN_STOP_PLANE_TEST      "Do you want to stop the plane test?"
    #define EN_IS_BABYSTEP          "Confirm to save the babystep value?"
    #define EN_IS_LANGUAGE          "Are you sure to save the settings?"
    #define EN_HOT_HOMING_ON        "HOT HOME:ON"
    #define EN_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define EN_HOT_HOMING_START     "HOT HOME:START!"
    #define EN_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define EN_HOT_HOMING_STOP      "HOT HOME:OK!" 
    #define EN_LIST_MODE            "LIST"
    #define EN_ICON_MODE            "ICON"   
#endif
#endif
