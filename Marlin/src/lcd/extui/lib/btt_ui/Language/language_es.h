...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define ES_SOFTENING            "Softening"
    #define ES_DEFAULT              "Restore default"
    #define ES_IS_DEFAULT           "¿Confirmar la restauración de la configuración de fábrica?"
    #define ES_DEFAULT_OK           "¡Configuración de fábrica restaurada!"
    #define ES_LEVEL_TEMP           "Wait for E0 to stabilize to 140 degrees" 
    #define ES_PSTOP                "Waiting for zero.."
    #define ES_LEVEL_BED_TEMP       "The hot bed stabilizes to 60"
    #define ES_LEVELING_OVEL        "Leveling is over!"
    #define ES_LEVELING_ING         "Leveling..."
    #define ES_MOVEMENT             "Movimiento"
    #define ES_OFF                  "OFF"
    #define ES_ON                   "ON"
    #define ES_COLDEXTRUD           "Prohibir la extrusión en frío (t0 < 170 grados)"
    #define ES_COLDEXTRUD170        "Precalentamiento"
    #define ES_CLEARNOZZ            "¡Limpiar la boquilla!"
    #define ES_MODE_SELECT          "Selección de patrones"
    #define ES_POWERLOSS_ON         "PLR ON"
    #define ES_POWERLOSS_OFF        "PLR OFF"
    #define ES_MOTOR_UNLOCK         "Desbloqueo del motor"
    #define ES_MESH_VALID           "Ensayo de Nivelación"
    #define ES_WAIT_FOR_TEMP        "Por favor, espere a que la temperatura aumente a la temperatura objetivo"
    #define ES_STOP_PLANE_TEST      "¿Detener la prueba de Nivelación?"
    #define ES_IS_BABYSTEP          "¿Está seguro de guardar los valores de ajuste?"
    #define ES_IS_LANGUAGE          "¿Está seguro de guardar la configuración?"
    #define ES_HOT_HOMING_ON        "HOT HOME:ON"
    #define ES_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define ES_HOT_HOMING_START     "HOT HOME:START!"
    #define ES_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define ES_HOT_HOMING_STOP      "HOT HOME:OK!"  
    #define ES_LIST_MODE            "LIST"
    #define ES_ICON_MODE            "ICON"  
#endif
#endif
