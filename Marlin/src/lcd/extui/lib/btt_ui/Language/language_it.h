...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define IT_SOFTENING            "ammorbidire"
    #define IT_DEFAULT              "default"
    #define IT_IS_DEFAULT           "Ripristina le impostazioni predefinite?"
    #define IT_DEFAULT_OK           "Impostazioni predefinite ripristinate!"
    #define IT_LEVEL_TEMP           "Nastro di riscaldamento 140 gradi"
    #define IT_PSTOP                "Aspetta la fine dello zero."
    #define IT_LEVEL_BED_TEMP       "Il letto caldo è stabilizzato a 60 gradi"
    #define IT_LEVELING_OVEL        "Livello completato!"
    #define IT_LEVELING_ING         "Levante."
    #define IT_MOVEMENT             "movimento"
    #define IT_OFF                  "OFF"
    #define IT_ON                   "ON"
    #define IT_COLDEXTRUD           "Nessuna estrusione a freddo (t0 <170 gradi)"
    #define IT_COLDEXTRUD170        "preriscalda"
    #define IT_CLEARNOZZ            "Pulisci l'ugello!"
    #define IT_MODE_SELECT          "Selezione della modalità"
    #define IT_POWERLOSS_ON         "PLR ON"
    #define IT_POWERLOSS_OFF        "PLR OFF"
    #define IT_MOTOR_UNLOCK         "Sbloccando"
    #define IT_MESH_VALID           "prova"
    #define IT_WAIT_FOR_TEMP        "Si prega di attendere che la temperatura aumenti alla temperatura di destinazione"
    #define IT_STOP_PLANE_TEST      "Smettere di regolare test?"
    #define IT_IS_BABYSTEP          "Sei sicuro di salvare il valore di taglio?"
    #define IT_IS_LANGUAGE          "Sei sicuro di salvare le impostazioni?"
    #define IT_HOT_HOMING_ON        "HOT HOME:ON"
    #define IT_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define IT_HOT_HOMING_START     "HOT HOME:START!"
    #define IT_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define IT_HOT_HOMING_STOP      "HOT HOME:OK!"   
    #define IT_LIST_MODE            "LIST"
    #define IT_ICON_MODE            "ICON" 
#endif
#endif
