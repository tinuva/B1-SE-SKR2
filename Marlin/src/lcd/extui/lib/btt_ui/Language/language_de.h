...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define DE_PRINTING_COMPLETED   "Printing completed!"
    ...
    #define DE_SOFTENING            "Weichmachende Verbrauchsmaterialien"
    #define DE_DEFAULT              "zurücksetzen"
    #define DE_IS_DEFAULT           "Bestätigen, um die Werkseinstellungen wiederherzustellen?"
    #define DE_DEFAULT_OK           "Werkseinstellungen wurden wiederhergestellt!"
    #define DE_LEVEL_TEMP           "Warten Sie, bis sich der Heizstab auf 140 Grad stabilisiert hat"
    #define DE_PSTOP                "Warten Sie, bis die Nullung beendet ist. ."
    #define DE_LEVEL_BED_TEMP       "Das heiße Bett stabilisiert sich auf 60 Grad"
    #define DE_LEVELING_OVEL        "Die Nivellierung ist abgeschlossen!"
    #define DE_LEVELING_ING         "Nivellierung. ."
    #define DE_MOVEMENT             "Bewegung"
    #define DE_OFF                  "OFF"
    #define DE_ON                   "ON"
    #define DE_COLDEXTRUD           "Kaltfließpressen ist verboten (T0<170 Grad)"
    #define DE_COLDEXTRUD170        "preheat"
    #define DE_CLEARNOZZ            "Reinigen Sie die Düse！"
    #define DE_MODE_SELECT          "Modusauswahl"
    #define DE_POWERLOSS_ON         "PLR ON"
    #define DE_POWERLOSS_OFF        "PLR OFF"
    #define DE_MOTOR_UNLOCK         "Motorentriegelung"
    #define DE_MESH_VALID           "Nivellierungstest"
    #define DE_WAIT_FOR_TEMP        "Bitte warten Sie, bis die Temperatur auf die Zieltemperatur angestiegen ist"
    #define DE_STOP_PLANE_TEST      "Möchten Sie den Nivellierungstest stoppen?"
    #define DE_IS_BABYSTEP          "Sind Sie sicher, dass Sie den Feinabstimmungswert speichern?"
    #define DE_IS_LANGUAGE          "Möchten Sie die Einstellungen wirklich speichern?"
    #define DE_HOT_HOMING_ON        "HOT HOME:ON"
    #define DE_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define DE_HOT_HOMING_START     "HOT HOME:START!"
    #define DE_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define DE_HOT_HOMING_STOP      "HOT HOME:OK!"    
    #define DE_LIST_MODE            "LIST"
    #define DE_ICON_MODE            "ICON"
#endif
#endif
