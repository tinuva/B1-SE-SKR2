...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define FR_SOFTENING            "Softening"
    #define FR_DEFAULT              "Paramètres par défaut"
    #define FR_IS_DEFAULT           "Confirmer la restauration des paramètres par défaut?"
    #define FR_DEFAULT_OK           "Paramètres par défaut restaurés"
    #define FR_LEVEL_TEMP           "Barre chauffante à 140 degrés"
    #define FR_PSTOP                "Attendez de revenir à zéro."
    #define FR_LEVEL_BED_TEMP       "Lit chaud stabilisé à 60 degrés"
    #define FR_LEVELING_OVEL        "Nivellement terminé!"
    #define FR_LEVELING_ING         "Nivellement..."
    #define FR_MOVEMENT             "Sports"
    #define FR_OFF                  "OFF"
    #define FR_ON                   "ON"
    #define FR_COLDEXTRUD           "Pas d'extrusion à froid (T0 < 170 degrés)"
    #define FR_COLDEXTRUD170        "Préchauffage"
    #define FR_CLEARNOZZ            "Nettoyez la buse !."
    #define FR_MODE_SELECT          "Sélection du mode"
    #define FR_POWERLOSS_ON         "PLR ON"
    #define FR_POWERLOSS_OFF        "PLR OFF"
    #define FR_MOTOR_UNLOCK         "Moteur déverrouillé"
    #define FR_MESH_VALID           "Tests"
    #define FR_WAIT_FOR_TEMP        "Veuillez attendre que la température atteigne la température cible."
    #define FR_STOP_PLANE_TEST      "Arrêter le test de nivellement?"
    #define FR_IS_BABYSTEP          "Êtes - vous sûr de sauvegarder les valeurs de compensation?"
    #define FR_IS_LANGUAGE          "Êtes-vous sûr d'enregistrer les paramètres ?"
    #define FR_HOT_HOMING_ON        "HOT HOME:ON"
    #define FR_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define FR_HOT_HOMING_START     "HOT HOME:START!"
    #define FR_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define FR_HOT_HOMING_STOP      "HOT HOME:OK!"    
    #define FR_LIST_MODE            "LIST"
    #define FR_ICON_MODE            "ICON"
#endif
#endif
