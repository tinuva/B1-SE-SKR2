...
#include "../../../../../inc/MarlinConfigPre.h"
    ...
    #define JP_SOFTENING            "消耗品の軟化"
    #define JP_DEFAULT              "リセット"
    #define JP_IS_DEFAULT           "工場出荷時の設定に戻すことを確認しますか？"
    #define JP_DEFAULT_OK           "工場出荷時の設定に戻りました！"
    #define JP_LEVEL_TEMP           "加熱ロッドが140度に安定するのを待ちます"
    #define JP_PSTOP                "ゼロ調整が終了するのを待ちます。 。"
    #define JP_LEVEL_BED_TEMP       "ホットベッドは60度に安定します"
    #define JP_LEVELING_OVEL        "レベリングが完了しました！"
    #define JP_LEVELING_ING         "レベリング。 。"
    #define JP_MOVEMENT             "移動"
    #define JP_OFF                  "OFF"
    #define JP_ON                   "ON"
    #define JP_COLDEXTRUD           "冷間押出しは禁止されています（T0 <170度）"
    #define JP_COLDEXTRUD170        "準備し始める"
    #define JP_CLEARNOZZ            "ノズルを掃除してください！"
    #define JP_MODE_SELECT          "モード選択"
    #define JP_POWERLOSS_ON         "PLR ON"
    #define JP_POWERLOSS_OFF        "PLR OFF"
    #define JP_MOTOR_UNLOCK         "モーターのロック解除"
    #define JP_MESH_VALID           "レベリングテスト"
    #define JP_WAIT_FOR_TEMP        "温度が目標温度まで上昇するまでお待ちください"
    #define JP_STOP_PLANE_TEST      "レベリングテストを停止しますか？"
    #define JP_IS_BABYSTEP          "微調整された値を保存してもよろしいですか？"
    #define JP_IS_LANGUAGE          "設定を保存してもよろしいですか？"
    #define JP_HOT_HOMING_ON        "HOT HOME:ON"
    #define JP_HOT_HOMING_OFF       "HOT HOME:OFF"
    #define JP_HOT_HOMING_START     "HOT HOME:START!"
    #define JP_HOT_HOMING_Z_HOMING  "HOT HOME:Z HOMING!"  
    #define JP_HOT_HOMING_STOP      "HOT HOME:OK!"   
    #define JP_LIST_MODE            "LIST"
    #define JP_ICON_MODE            "ICON" 
#endif
#endif
