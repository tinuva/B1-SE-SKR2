...
void DrawLevelProgressInfo()
{
 ...
 GUI_DispString(LEVEL_RPOGRESS_INFO_STEPX , LEVEL_RPOGRESS_INFO_STEPY, (uint8_t *)">>T:" STRINGIFY(LEVEL_CLEAR_PREHEAT_TEMP) " B:" STRINGIFY(LEVEL_PREHEAT_BED));
 ...
 GUI_DispString(LEVEL_RPOGRESS_INFO_STEPX , LEVEL_RPOGRESS_INFO_STEPY+BYTE_HEIGHT*2, (uint8_t *)"  T:" STRINGIFY(LEVEL_PREHEAT_TEMP) " B:" STRINGIFY(LEVEL_PREHEAT_BED));
