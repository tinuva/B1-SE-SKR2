...
#include "env_validate.h"
  ...
  #define BOARD_INFO_NAME "BTT SKR 2"
#endif
...
#else
  #ifndef Z_STOP_PIN
    #ifdef USE_Z_LIGHT_SWITCH
      #define Z_STOP_PIN                       PC0   // Z-STOP
    #else
      #define Z_STOP_PIN                       PE4  // Z-STOP
    #endif
  #endif
#endif
...
//
  ...
  #define BTN_ENC                    EXP1_09_PIN
    ...
    #define TFT_A0_PIN                     PC4
    #define TFT_SCK_PIN                    PA5
    #define TFT_MISO_PIN                   PA6
    #define TFT_MOSI_PIN                   PA7

    #define TOUCH_INT_PIN                  PE12
    #define TOUCH_MISO_PIN                 PE11
    #define TOUCH_MOSI_PIN                 PB1
    #define TOUCH_SCK_PIN                  PE10
    #define TOUCH_CS_PIN                   PE9

    #define TOUCH_CALIBRATION_X 17924
    #define TOUCH_CALIBRATION_Y -11857
    #define TOUCH_OFFSET_X -31
    #define TOUCH_OFFSET_Y 343
    #define TOUCH_ORIENTATION TOUCH_LANDSCAPE

    #define BTN_EN1                        PE7  // (31) J3-2 & AUX-4
    #define BTN_EN2                        PB2  // (33) J3-4 & AUX-4
  #else
    ...
    #define W25Qxx_CS_PIN                  PE13
    
    #define SPI4LINLCD_CS0                 PA4
    #define SPI4LINLCD_RS                  PC4
    #define SPI4LINLCD_SCL                 PA5
    #define SPI4LINLCD_SDA                 PA7 

    #define LCD_ENCA_PIN                   PE7
    #define LCD_ENCB_PIN                   PB2
    #define LCD_BTN_PIN                    PB0
    
    #define TFT_CS_PIN                     SPI4LINLCD_CS0
    #define TFT_A0_PIN                     SPI4LINLCD_RS
    //#define TFT_DC_PIN                   PC4
    #define TFT_SCK_PIN                    SPI4LINLCD_SCL
    #define TFT_MISO_PIN                   PA6
    #define TFT_MOSI_PIN                   SPI4LINLCD_SDA
