...
#define STRING_CONFIG_H_AUTHOR "(BIQU, B1SE)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_2
#endif

//Machine model
#define B1_SE                  1    //B1-SE PRODUCT Z E use A4988
#define B1_SE_PLUS             2    //NO SPI_SCREEN
#define B1_SE_ALL_TMC          3    //B1-SE PRODUCT Z E use TMC2225
#define B1_SE_PLUS_SPI         4    //SPI-SCREEN
 
// 
#define BTT_MACCHINE   B1_SE_PLUS_SPI

  #if BTT_MACCHINE == B1_SE_PLUS_SPI
    //For Cyclops or any "multi-extruder" that shares a single nozzle.
   //#define DUAL_E                   
  #endif
// 
#if BTT_MACCHINE == B1_SE_PLUS
  //B1_SE_PLUS   
#else
  /*
  ...
  */   
  //#define BTT_TFT35_SPIV1_0
     ...
     #define BTT_DUAL_MODE     //Imperfect dual mode function,Not available at the moment
    #endif
  #endif
  #define ADD_SD_SUPPORT 1  //use U-disk  and SD card 
#endif

//#define BTT_H2_EXTRUDERS          //BTT H2EXTRUDERS
//#define USE_Z_LIGHT_SWITCH

//#define Z_HOT_HOMING       //Home warming function during printing
#ifdef Z_HOT_HOMING      
  #define HOT_HOMING_DEFAULT_STATE  true  //HIGH:OPEN LOW:OFF
  #define HOT_HOMING_MAX_TEMP       185
  #define HOT_HOMING_DEFAULT_TEMP   180
#endif
...
#if BTT_MACCHINE == B1_SE_PLUS_SPI
  #define CUSTOM_MACHINE_NAME "BIQU B1SE-PLUS"
#elif BTT_MACCHINE ==  B1_SE || BTT_MACCHINE == B1_SE_ALL_TMC
  #define CUSTOM_MACHINE_NAME "BIQU-B1SE"
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #if BTT_MACCHINE == B1_SE_PLUS ||BTT_MACCHINE == B1_SE_PLUS_SPI
...
#if BTT_MACCHINE == B1_SE_PLUS ||BTT_MACCHINE == B1_SE_PLUS_SPI ||BTT_MACCHINE == B1_SE_ALL_TMC             
 ...
 */
#ifdef BLTOUCH
  #define NOZZLE_TO_PROBE_OFFSET { -45.69, 3.2, 3 }
#else
...
#define XY_PROBE_FEEDRATE (133*200)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST 3*60 

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW 60*2
