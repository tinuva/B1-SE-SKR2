...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           120//45  // (seconds) Time limit before the nozzle is turned off for safety.
 ...
 * Detect whether the driver is anti reverse pluged when power on.
